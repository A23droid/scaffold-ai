"""Add parentEmails to StudentProfile

Revision ID: 4c3f3b20433d
Revises: 7beb52335c7f
Create Date: 2026-06-14 03:36:59.123770
...
revision: str = '4c3f3b20433d'
down_revision: Union[str, Sequence[str], None] = '7beb52335c7f'
...
def upgrade() -> None:
    ...
    op.add_column('student_profiles', sa.Column('parentEmails', sa.String(), nullable=True))
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column('student_profiles', 'parentEmails')
