...
Revision ID: 7beb52335c7f
Revises: fb7b13e8a454
Create Date: 2026-06-14 01:19:53.579699
...
revision: str = '7beb52335c7f'
down_revision: Union[str, Sequence[str], None] = 'fb7b13e8a454'
...
def upgrade() -> None:
    """Upgrade schema."""
    op.add_column('student_profiles', sa.Column('lastActiveAt', sa.DateTime(timezone=True), nullable=True))
...
def downgrade() -> None:
    ...
    op.drop_column('student_profiles', 'lastActiveAt')
