        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white border border-zinc-200/60 rounded-2xl p-6 shadow-[0_8px_30px_rgba(120,80,200,0.03)] hover:shadow-[0_12px_36px_rgba(120,80,200,0.05)] transition-all duration-300">
            <div className="flex flex-col gap-4">
              ...
              <form onSubmit={handleStartSession} className="flex gap-2.5">
                <input 
                  type="text" 
                  required
                  value={prompt}
                    ...
                    <tr key={s.id} className="hover:bg-zinc-50/50 transition-colors">
                      ...
                      <td className="py-3.5">
                        <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-[9px] font-bold capitalize border ${
                          s.intent === "CONCEPT_UNDERSTANDING" ? "bg-purple-50 text-purple-700 border-purple-200/40" :
                      ...
                      <td className="py-3.5">
                        <span className={`text-[9px] font-bold px-2 py-0.5 rounded-full border ${
                          s.status === "COMPLETED" ? "bg-emerald-50 text-emerald-700 border-emerald-200/40" : "bg-amber-50 text-amber-700 border-amber-200/40"
                        }`}>{s.status}</span>
                      </td>
